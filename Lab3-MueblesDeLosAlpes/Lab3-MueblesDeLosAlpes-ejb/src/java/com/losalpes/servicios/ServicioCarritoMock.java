...
public class ServicioCarritoMock implements IServicioCarritoMockRemote, IServicioCarritoMockLocal
{
    ...
    {   
        ...
        for (int i = 0; i < inventario.size(); i++)
        {
            ...
            String ciudadUsuario = usuario.getCiudad().getNombre();            
            RegistroVenta compra=new RegistroVenta(new Date(System.currentTimeMillis()), mueble, mueble.getCantidad(), ciudadUsuario, usuario);
